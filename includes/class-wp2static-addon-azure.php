...
class Wp2static_Addon_Azure {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Wp2static_Addon_Azure_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Wp2static_Addon_Azure_Loader. Orchestrates the hooks of the plugin.
	 * - Wp2static_Addon_Azure_i18n. Defines internationalization functionality.
	 * - Wp2static_Addon_Azure_Admin. Defines all hooks for the admin area.
	 * - Wp2static_Addon_Azure_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the Wp2static_Addon_Azure_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wp2static_Addon_Azure_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wp2static_Addon_Azure_Loader    Orchestrates the hooks of the plugin.
	 */
